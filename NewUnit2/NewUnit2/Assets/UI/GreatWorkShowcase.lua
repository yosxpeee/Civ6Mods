...
--	Show / Hide
-- ===========================================================================
function StopYNLGreatWorkSounds()
	UI.PlaySound("Stop_GMLadyGagaBadRomance");
	UI.PlaySound("Stop_GMLadyGagaPokerFace");
	UI.PlaySound("Stop_GMMikuHatsuneMelt");
	UI.PlaySound("Stop_GMMikuHatsuneShiteyanyo");
	UI.PlaySound("Stop_GREAT_WRITING_BRADLEY_BOND_1");
	UI.PlaySound("Stop_GREAT_WRITING_BRADLEY_BOND_2");
	UI.PlaySound("Stop_GREAT_WRITING_CHE_GUEVARA");
	UI.PlaySound("Stop_GREAT_WRITING_HOWARD_PHILLIPS_LOVECRAFT_1");
	UI.PlaySound("Stop_GREAT_WRITING_HOWARD_PHILLIPS_LOVECRAFT_2");
end
function ShowScreen()
	UpdateData();
