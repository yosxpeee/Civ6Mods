...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Resources/Stone/03_Texture/RES_Stone_G.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1937033493</m_ExportedTime>
	<m_ClassName text="Generic_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="RES_Stone_G_YZSP_BB.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="RES_Stone_G_YZSP_BB"/>
	<m_Description text=""/>
	<m_Tags>
