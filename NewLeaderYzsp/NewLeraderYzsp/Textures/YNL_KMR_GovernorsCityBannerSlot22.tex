...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/UI/Icons/Governors/YNL_KMR_GovernorsCityBannerSlot22.psd"/>
	<m_SourceObjectName text="Governors"/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>153112387</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="YNL_KMR_GovernorsCityBannerSlot22.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="YNL_KMR_GovernorsCityBannerSlot22"/>
	<m_Description text=""/>
	<m_Tags>
