...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Resources/Stone/03_Texture/RES_Stone_B.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3608363177</m_ExportedTime>
	<m_ClassName text="Generic_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="RES_Stone_B_YZSP_BB.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="RES_Stone_B_YZSP_BB"/>
	<m_Description text=""/>
	<m_Tags>
