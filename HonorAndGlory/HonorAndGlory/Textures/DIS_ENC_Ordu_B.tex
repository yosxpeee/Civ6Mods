...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Districts/Encampment/03_Texture/DIS_ENC_Ordu_B.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>796507176</m_ExportedTime>
	<m_ClassName text="Generic_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="DIS_ENC_Ordu_B.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="DIS_ENC_Ordu_B"/>
	<m_Description text=""/>
	<m_Tags>
